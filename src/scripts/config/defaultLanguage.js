(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Support aria2 input file format. One download per URL line, options on indented lines. Use "filename$URL" to specify the output file name.': 'aria2 input file format. One URL per line, options on indented lines. Additionally, you can use "filename$URL" to specify the output file name.',
            ...
            'format': {
                ...
                'task.new.special-download-links': 'Download Links ({{count}} Links):',
